...
$paginas_permitidas_admin = ['admin_dashboard', 'admin_usuarios', 'admin_relatorios', 'admin_smtp_config', 'admin_configuracoes', 'admin_banner', 'admin_revenda_autorizada', 'admin_broadcast', 'saas_config', 'saas_planos', 'saas_gateways', 'saas_assinaturas', 'admin_login_texts'];
...
<body class="font-sans flex flex-col min-h-screen" style="background-color: #07090d;">
    ...
    <aside id="admin-sidebar" class="sidebar-glass fixed top-0 left-0 bottom-0 z-50 transform -translate-x-full transition-transform duration-300 w-full max-w-xs md:translate-x-0 md:w-64 flex flex-col overflow-y-auto">
        ...
        <nav class="mt-4 flex-grow px-2">
            ...
            <div class="ml-4 mt-1 space-y-1">
                ...
                <a href="/admin?pagina=admin_login_texts" class="<?php echo $pagina_admin == 'admin_login_texts' ? $active_class : $inactive_class; ?>">
                    <i data-lucide="type" class="w-4 h-4"></i>
                    <span>Textos do Login</span>
                </a>
            </div>
    ...
    <div id="live-notification-container" class="live-notification-container">
        <img id="live-notification-product-image" src="https://i.ibb.co/BK3HTsX9/moedamonney.png" alt="Produto" class="live-notification-product-image">
        <div>
    ...
    <script>
        ...
        function _actualDisplayLiveNotification(notification) {
            ...
            liveNotificationProductImage.src = notification.produto_foto ? 'uploads/' + notification.produto_foto : 'https://i.ibb.co/BK3HTsX9/moedamonney.png';
