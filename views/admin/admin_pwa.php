...
<div class="flex items-center justify-between mb-6">
    <div>
        <h1 class="text-3xl font-bold text-white">Configurações do Aplicativo</h1>
        <p class="text-gray-400 mt-1">Configure o aplicativo mobile da plataforma.</p>
    </div>
...
<div class="pwa-sales-hero rounded-2xl p-12 mb-8 text-center relative">
    <div class="relative z-10">
        ...
        <p class="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Com o módulo App, seus usuários podem instalar sua plataforma diretamente no celular, 
            receber notificações push e ter uma experiência mobile de primeira classe.
        </p>
        <a href="https://contate.top/pwapp" target="_blank" class="pwa-cta-button inline-flex items-center gap-3 px-8 py-4 rounded-xl text-white font-bold text-lg">
            <i data-lucide="shopping-cart" class="w-6 h-6"></i>
            <span>Comprar Módulo App</span>
...
<!-- Benefícios -->
<div class="mb-8">
    <h2 class="text-3xl font-bold text-white mb-6 text-center">Por que ter um Aplicativo?</h2>
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="pwa-benefit-card bg-dark-card p-6 rounded-xl">
            ...
            <p class="text-gray-400">Interface otimizada para dispositivos móveis, com suporta para iOS e Android.</p>
        </div>
...
<div class="bg-dark-card p-8 rounded-xl mb-8 border border-dark-border">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl mx-auto">
        <div class="flex items-start gap-4">
            ...
            <div>
                <h4 class="text-lg font-semibold text-white mb-1">Instalação Completa</h4>
...
<div class="bg-gradient-to-r from-green-600/20 to-green-500/20 border border-green-500/30 rounded-2xl p-12 text-center">
    ...
    <p class="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
        Adquira o módulo App agora e ofereça a melhor experiência mobile para seus usuários.
    </p>
    <a href="https://contate.top/pwapp" target="_blank" class="pwa-cta-button inline-flex items-center gap-3 px-10 py-5 rounded-xl text-white font-bold text-xl">
