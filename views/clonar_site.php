...
<script>
    ...
    cloneForm.addEventListener('submit', async (e) => {
        ...
        try {
            const response = await fetch('/api/cloned_sites_api.php?action=clone_url', {
                method: 'POST',
    ...
    saveVisualEditorBtn.addEventListener('click', async () => {
        ...
        try {
            const response = await fetch('/api/cloned_sites_api.php?action=save_cloned_site', {
                method: 'POST',
                headers: { 
    ...
    async function loadClonedSites() {
        try {
            const response = await fetch('/api/cloned_sites_api.php?action=get_cloned_sites');
    ...
    async function editClonedSite(id) {
        ...
        try {
            const response = await fetch(`/api/cloned_sites_api.php?action=get_cloned_site_details&cloned_site_id=${id}`);
    ...
    async function deleteClonedSite(id) {
        ...
        try {
            const response = await fetch('/api/cloned_sites_api.php?action=delete_cloned_site', {
                method: 'POST',
                headers: { 
                    'Content-Type': 'application/json'
                },
