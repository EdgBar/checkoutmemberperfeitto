<div class="container mx-auto">
    ...
    <!-- NOVA SEÇÃO: Jornada CheckoutPRO -->
    ...
    <div class="bg-gradient-to-br from-purple-800 via-indigo-900 to-black p-6 rounded-lg shadow-md mb-6 text-white relative overflow-hidden">
        ...
        <div class="relative z-10">
            <h2 class="text-3xl font-extrabold text-white mb-4">Sua Jornada CheckoutPRO</h2>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Mapeamento das etapas da jornada CheckoutPRO
    // COMENTADO - Não será usado por enquanto
    /*
    const STARFY_STAGES = [
        { name: 'ESTRELA CADENTE', min: 0, max: 10000, description: 'Toda grande jornada começa com um vislumbre. Você acendeu a sua luz no universo CheckoutPRO. É o ponto de partida de uma trajetória que promete ser épica.', color: 'from-purple-800 via-indigo-900 to-black' },
        { name: 'NEBULOSA ASCENDENTE', min: 10000, max: 100000, description: 'Uma formação se inicia, cores vibrantes e um brilho crescente. Você está moldando seu espaço na galáxia CheckoutPRO, com potencial para se expandir e impressionar.', color: 'from-indigo-900 via-blue-950 to-gray-900' },
    ...
    function renderFlixMembersJourney(totalFaturamentoLifetime) {
        ...
        if (currentStage) {
            ...
            if (currentStage.max === Infinity) { 
                ...
                document.getElementById('journey-next-stage-message').textContent = 'Você alcançou o ápice da Jornada CheckoutPRO!';
            } else {
    ...
    function updateKpiAndChart(period = 'today') {
        ...
        fetch(`/api/api.php?action=get_dashboard_data&period=${period}`)
            ...
            .then(data => {
                ...
                // Renderiza a Jornada CheckoutPRO com o faturamento lifetime
                // COMENTADO - Não será usado por enquanto
                // renderFlixMembersJourney(data.kpis.total_faturamento_lifetime);
