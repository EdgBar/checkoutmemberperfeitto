...
<div class="container mx-auto">
    ...
    <div class="bg-gradient-to-br from-blue-900/30 via-purple-900/20 to-indigo-900/30 rounded-lg p-8 mb-6 border" style="border-color: var(--accent-primary);">
        <div class="flex flex-col md:flex-row items-center gap-6">
            ...
            <div class="flex-1 text-center md:text-left">
                ...
                <a href="https://contate.top/pwapp" target="_blank" class="inline-flex items-center gap-2 text-white font-bold py-3 px-6 rounded-lg transition-all duration-300 hover:scale-105" style="background-color: var(--accent-primary);" onmouseover="this.style.backgroundColor='var(--accent-primary-hover)'" onmouseout="this.style.backgroundColor='var(--accent-primary)'">
    ...
    <div class="bg-gradient-to-r from-primary/20 to-primary/10 rounded-lg p-8 border text-center" style="border-color: var(--accent-primary); background: linear-gradient(to right, color-mix(in srgb, var(--accent-primary) 20%, transparent), color-mix(in srgb, var(--accent-primary) 10%, transparent));">
        ...
        <a href="https://contate.top/pwapp" target="_blank" class="inline-flex items-center gap-2 text-white font-bold py-4 px-8 rounded-lg transition-all duration-300 hover:scale-105 shadow-lg" style="background-color: var(--accent-primary);" onmouseover="this.style.backgroundColor='var(--accent-primary-hover)'" onmouseout="this.style.backgroundColor='var(--accent-primary)'">
            <i data-lucide="shopping-cart" class="w-5 h-5"></i>
