    ...
    <div class="w-full max-w-[450px] bg-white p-8 md:p-12 rounded-3xl shadow-2xl shadow-slate-200/50 border border-slate-100">
        ...
        <div class="text-center mb-10">
            <div class="inline-flex justify-center p-4 rounded-3xl mb-6">
                 <img src="<?php echo htmlspecialchars($logo_checkout_url); ?>" alt="Logotipo da CheckoutPRO" class="w-auto h-12 object-contain">
            </div>
        ...
        <p class="text-center text-xs text-slate-400 mt-10">
            &copy; <?php echo date("Y"); ?> <?php echo htmlspecialchars($nome_plataforma ?? 'CheckoutPRO'); ?>. Todos os direitos reservados.
        </p>
    </div>
