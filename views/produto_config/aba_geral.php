    ...
    <div>
        ...
        <div class="bg-dark-elevated p-4 md:p-6 rounded-lg border border-dark-border space-y-4">
            <div>
                ...
                <input type="hidden" id="tipo_entrega" name="tipo_entrega" value="<?php echo htmlspecialchars($produto['tipo_entrega'] ?? 'link_externo'); ?>">
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <div class="entrega-option-card cursor-pointer p-4 rounded-lg border-2 transition-all duration-200 bg-dark-card hover:bg-dark-elevated <?php echo (($produto['tipo_entrega'] ?? 'link_externo') == 'link_externo') ? 'border-[var(--accent-primary)] bg-dark-elevated' : 'border-dark-border'; ?>" data-value="link_externo" onclick="selectEntregaOption('link_externo')">
                    ...
                    <div class="entrega-option-card cursor-pointer p-4 rounded-lg border-2 transition-all duration-200 bg-dark-card hover:bg-dark-elevated <?php echo (($produto['tipo_entrega'] ?? '') == 'arquivo') ? 'border-[var(--accent-primary)] bg-dark-elevated' : 'border-dark-border'; ?>" data-value="arquivo" onclick="selectEntregaOption('arquivo')">
                        <div class="flex flex-col items-center text-center space-y-2">
                            <div class="w-12 h-12 rounded-lg flex items-center justify-center mb-2" style="background-color: color-mix(in srgb, var(--accent-primary) 20%, transparent);">
                    ...
                    <div class="entrega-option-card cursor-pointer p-4 rounded-lg border-2 transition-all duration-200 bg-dark-card hover:bg-dark-elevated <?php echo (($produto['tipo_entrega'] ?? '') == 'manual') ? 'border-[var(--accent-primary)] bg-dark-elevated' : 'border-dark-border'; ?>" data-value="manual" onclick="selectEntregaOption('manual')">
                        <div class="flex flex-col items-center text-center space-y-2">
                            <div class="w-12 h-12 rounded-lg flex items-center justify-center mb-2" style="background-color: color-mix(in srgb, var(--accent-primary) 20%, transparent);">
                                <i data-lucide="package" class="w-6 h-6" style="color: var(--accent-primary);"></i>
                            </div>
                            <h3 class="font-semibold text-white text-sm">Manual</h3>
                            <p class="text-xs text-gray-400">Entrega manual</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div id="entrega-fields-container">
                <div id="entrega-link-container" class="animate-fade-in-down" style="display: <?php echo (($produto['tipo_entrega'] ?? '') === 'link_externo') ? 'block' : 'none'; ?>;">
                    <label for="conteudo_entrega_link" class="block text-gray-300 text-sm font-medium mb-2">URL de Acesso</label>
                    <input type="url" id="conteudo_entrega_link" name="conteudo_entrega_link" class="form-input" placeholder="https://" value="<?php echo ($produto['tipo_entrega'] ?? '') === 'link_externo' ? htmlspecialchars($produto['conteudo_entrega'] ?? '') : ''; ?>">
                </div>

                <div id="entrega-pdf-container" class="animate-fade-in-down" style="display: <?php echo (($produto['tipo_entrega'] ?? '') === 'arquivo') ? 'block' : 'none'; ?>;">
                    <label class="block text-gray-300 text-sm font-medium mb-2">Upload do Arquivo PDF</label>
                    <?php if (($produto['tipo_entrega'] ?? '') == 'arquivo' && !empty($produto['conteudo_entrega'])): ?>
                ...
                <div id="entrega-fisico-container" class="animate-fade-in-down" style="display: <?php echo (($produto['tipo_entrega'] ?? '') === 'manual') ? 'block' : 'none'; ?>;">
                    <div class="flex items-start p-3 md:p-4 bg-green-900/20 border border-green-500/30 rounded-lg">
                        ...
                        <div class="flex-1 min-w-0">
                            <h4 class="font-bold text-green-300 text-sm">Entrega Manual</h4>
                            <p class="text-xs md:text-sm text-green-200 mt-1">A entrega será feita manualmente após a compra.</p>
                        </div>
                    </div>
                </div>
            </div>
